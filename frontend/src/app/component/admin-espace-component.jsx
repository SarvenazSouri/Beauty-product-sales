...
const AdminEspace = () => {
  ...
  useEffect(() => {
    ...
    axios({
      method: "post",
      url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/listCommandes",
      timeout: 4000,
    })
      .then((response) => {
    ...
    axios({
      method: "GET",
      url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/listProduits",
      timeout: 4000,
    })
      .then((response) => {
    ...
    axios({
      method: "GET",
      url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/listCategorie",
      timeout: 4000,
    })
      .then((response) => {
  ...
  const handleSupprimer = (id_produit) => {
    fetch(
      "http://localhost:8081/W17-venteEnLigne/ExecuteServer/supprimerProduit",
      {
        method: "POST",
        headers: {
  ...
  const updateProduit = () => {
    fetch("http://localhost:8081/W17-venteEnLigne/ExecuteServer/modifierProduit",{
      method: "POST",
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const ajouterProduct = () => {
    fetch(
      "http://localhost:8081/W17-venteEnLigne/ExecuteServer/ajouterProduit",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",

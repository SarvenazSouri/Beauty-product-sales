...
import axios from "axios";
    ...
    function CLients(){
        ...
        useEffect(() => {
            ...
            axios({
              method: "POST",
              url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/listCommandeUser",
        ...
        const updateInfo = () => {
            axios({
                method: "POST",
                url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/updateUser",
                data: JSON.stringify({
                    id: id,
        ...
        const updatePassword = () => {
            ...
            if (password === confirm) {
                axios({
                    method: "POST",
                    url: "http://localhost:8081/W17-venteEnLigne/ExecuteServer/updatePassword",
                    data: JSON.stringify({
                        id: id,
                        password: password,
                    }),
